...
import { useGetSnippetsById } from "../query";
...
const Page = () => {
  ...
  return (
    <div className="flex flex-col text-white items-center justify-center h-full w-full bg-gradient-to-br from-blue-50 to-blue-100 dark:from-zinc-900 dark:to-zinc-800 rounded-xl p-6">
